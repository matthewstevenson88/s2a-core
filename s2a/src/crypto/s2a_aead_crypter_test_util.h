...
#ifndef S2A_SRC_CRYPTO_S2A_AEAD_CRYPTER_TEST_UTIL_H_
#define S2A_SRC_CRYPTO_S2A_AEAD_CRYPTER_TEST_UTIL_H_
...
#endif  // S2A_SRC_CRYPTO_S2A_AEAD_CRYPTER_TEST_UTIL_H_
