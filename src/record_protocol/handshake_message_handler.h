...
#ifndef SRC_RECORD_PROTOCOL_HANDSHAKE_MESSAGE_HANDLER_H_
#define SRC_RECORD_PROTOCOL_HANDSHAKE_MESSAGE_HANDLER_H_
...
#endif  // SRC_RECORD_PROTOCOL_HANDSHAKE_MESSAGE_HANDLER_H_
