...
#ifndef SRC_RECORD_PROTOCOL_S2A_CRYPTER_H_
#define SRC_RECORD_PROTOCOL_S2A_CRYPTER_H_
...
#include "src/record_protocol/s2a_half_connection.h"
...
#endif  //  SRC_RECORD_PROTOCOL_S2A_CRYPTER_H_
