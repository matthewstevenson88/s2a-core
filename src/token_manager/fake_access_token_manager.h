...
#ifndef SRC_TOKEN_MANAGER_FAKE_ACCESS_TOKEN_MANAGER_H_
#define SRC_TOKEN_MANAGER_FAKE_ACCESS_TOKEN_MANAGER_H_
...
#endif  // SRC_TOKEN_MANAGER_FAKE_ACCESS_TOKEN_MANAGER_H_
